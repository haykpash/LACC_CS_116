...
// Write a C++ statement that outputs the values of name and 
// studyHours with the appropriate text. For example, if the 
// value of name is "Donald" and the value of studyHours is 4.5, 
// the output is:
